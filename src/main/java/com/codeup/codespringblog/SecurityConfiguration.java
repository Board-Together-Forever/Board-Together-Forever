...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/", "/posts", "/register", "/gamesessions", "/css/**", "/js/**", "/gameIMG/**", "/js/bga.js" ,"/js/api_keys.js", "apiSearch.html", "/aboutCreators", "/aboutuser/**", "/gamesessions/search", "/error/**", "/users/search") // anyone can see the home and the ads pages
                .permitAll()
